...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Console.println("""
                ...
                - To have the player controlled by the computer, enter @ followed by one of the following names:
                - 'L' for Linus (picks next available space)
                - 'O' for Omola (looks one move ahead)
                """);
